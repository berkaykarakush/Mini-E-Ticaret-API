...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class BasketsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetBasketItems([FromQuery]GetBasketsItemsQueryRequest getBasketsItemsQueryRequest)
        {
            List<GetBasketsItemsQueryResponse> response = await _mediator.Send(getBasketsItemsQueryRequest);
            return Ok(response);
        }
        [HttpPost]
